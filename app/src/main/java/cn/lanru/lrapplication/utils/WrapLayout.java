...
public class WrapLayout extends ViewGroup {
    ...
    private void createChild(String[][] data, final Context context, int textSize, int pl, int pt, int pr, int pb, int ml, int mt, int mr, int mb){
        ...
        for(int i = 0;i<size;i++){
            ...
            background.setColor(Color.argb(100, 241, 245, 255));
            background.setStroke(1, Color.BLUE);
            ...
            if (style == TEXTVIEW_STYLE){
                ...
                ((TextView) btn).setPadding(3, 8, 3, 8);
                ((TextView) btn).setBackgroundResource(R.drawable.button_empty);
                ...
                ((Button) btn).setBackgroundResource(R.drawable.button_empty);
