...
public class AaddressActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aaddress);

        tvUserName = findViewById(R.id.username);
        tvmobile = findViewById(R.id.mobile);
        tvAddress = findViewById(R.id.address);
        stStatus = findViewById(R.id.status);
    ...
    public void onClickAdd (View view) {
        Intent intent = new Intent(mContext, AaddressActivity.class);
    ...
    public void showPickerView(View view) {// 弹出选择器
