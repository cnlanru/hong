...
public class QrcodeActivity extends BaseActivity {
    ...
    public void initData () {
        ...
        Glide.with(mContext)
                .load(SharedHelper.getString(mContext, "avatar", "")).apply(options)
                .into(ivFace);

        qrcode.setImageBitmap(createQRCodeBitmap(
                SharedHelper.getInt(mContext, "id", 0) + "",
                100, 100,"UTF-8","H", "1", Color.BLACK, Color.WHITE
        ));
    }
